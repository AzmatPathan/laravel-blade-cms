...
<section class="w3-padding">
    ...
    <form method="post" action="/console/experiences/add" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="company_name" name="company_name" id="company_name" value="{{old('company_name')}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="designation" name="designation" id="designation" value="{{old('designation')}}">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="experience_from" id="experience_from" value="{{old('experience_from')}}" required>
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="experience_to" id="experience_to" value="{{old('experience_to')}}" required>
